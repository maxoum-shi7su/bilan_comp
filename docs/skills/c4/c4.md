...
Étant seul au développement au début du projet, Romain a rapidement compris qu’il avait besoin d’un MVP (Minimum Viable Product) pour tester son concept.  
Le développement du premier MVP a été confié à une équipe d’étudiants BUT3 (parcours Application Web et Mobile) sur 5 semaines.  
...
Ce second projet a été mené dans le cadre d’un projet tutoré, en lien avec mon entreprise Elio.  
